...
const HeroSection = () => {
    const [frontImage, setFrontImage] = useState("./images/front-img.webp");
    useEffect(() => {
        const imgTimeout = setTimeout(() => {
            setFrontImage("./images/ferrari.avif");
        }, 5000);
        return () => clearTimeout(imgTimeout);
        
    }, []);
  return (
    <section className="relative min-h-screen bg-[#0c0f1a] overflow-hidden" style={{ backgroundImage: `url(${frontImage})`, backgroundSize: "cover", backgroundPosition: "center" }}>
